...
/**
 * @brief Gets a music from the radio by its index.
 * @author Alejandro Dominguez
 * @param r Pointer to the radio.
 * @param index Index of the music in the radio.
 *
 * @return Returns a pointer to the music at index, or NULL if there is any error.
 */
